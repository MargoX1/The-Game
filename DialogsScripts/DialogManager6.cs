...
public class DialogManager6 : MonoBehaviour
{
    ...
    public static bool dialogManager6;
    ...
    private void Update()
    {
        if ((HelShowName.showHelName == true || StoneClick._StoneHel_draw == true) && DialogManager5.dialogManager5 == true)
        {
            StartCoroutine(RunStudyDialog());
            DialogManager5.dialogManager5 = false;
        }
    }
